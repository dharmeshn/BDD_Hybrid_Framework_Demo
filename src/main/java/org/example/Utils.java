...
public class Utils extends BasePage{
    ...
    String emailIDForRegistration = LoadProp.getProperty("EmailLP")+getTimeStamp()+
            LoadProp.getProperty("EmailDP");
    ...
    public static void moveToElementAndTypeText(By by, String textToFill){
        Actions builder = new Actions(driver);
        WebElement element = driver.findElement(by);
        // Created a sendKeys action using the Actions object to type text
...
//        System.out.println(afterHoverCSSKeyValue);
    ...
    public static void assertCurrentUrl(String urlLink){
